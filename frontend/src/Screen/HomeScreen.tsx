    ...
    <Screen isLoading={isLoading} isError={isError}>
      <div className="max-w-[1600px] mx-auto w-full">
        ...
        <section className="mb-12 flex flex-col md:flex-row md:justify-between md:items-end gap-6 px-4 md:px-0">
          <div>
            <h2 className="text-4xl font-light text-blue-900 tracking-tighter mb-2">Curated Arrivals</h2>
            <p className="text-on-surface-variant font-light">Explore unique pieces from our global ateliers.</p>
          </div>
              ...
              <div ref={loadMoreRef} className="py-20 flex flex-col items-center justify-center gap-4">
                {isFetchingNextPage && (
                  <>
                    ...
                    <p className="font-manrope text-xs uppercase tracking-widest text-on-surface-variant">Discovering more pieces...</p>
                  </>
                )}
              </div>
            )}
